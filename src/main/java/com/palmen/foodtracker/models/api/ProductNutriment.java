...
public class ProductNutriment {
	...
	private double energy_kcal_value_computed;
	private int energy_kj;
	private int energy_kj_100g;
	private String energy_kj_unit;
	private double energy_kj_value;
	private double energy_kj_value_computed;
	...
	private double fruits_vegetables_legumes_estimate_from_ingredients_100g;
	private double fruits_vegetables_legumes_estimate_from_ingredients_serving;
	private double fruits_vegetables_nuts_estimate_from_ingredients_100g;
	private double fruits_vegetables_nuts_estimate_from_ingredients_serving;
	...
	public double getEnergy_kcal_value_computed() {
		return energy_kcal_value_computed;
	}

	public void setEnergy_kcal_value_computed(double energy_kcal_value_computed) {
		this.energy_kcal_value_computed = energy_kcal_value_computed;
	}
	...
	public int getEnergy_kj_100g() {
		return energy_kj_100g;
	}

	public void setEnergy_kj_100g(int energy_kj_100g) {
		this.energy_kj_100g = energy_kj_100g;
	}

	public String getEnergy_kj_unit() {
		return energy_kj_unit;
	}

	public void setEnergy_kj_unit(String energy_kj_unit) {
		this.energy_kj_unit = energy_kj_unit;
	}

	public double getEnergy_kj_value() {
		return energy_kj_value;
	}

	public void setEnergy_kj_value(double energy_kj_value) {
		this.energy_kj_value = energy_kj_value;
	}

	public double getEnergy_kj_value_computed() {
		return energy_kj_value_computed;
	}

	public void setEnergy_kj_value_computed(double energy_kj_value_computed) {
		this.energy_kj_value_computed = energy_kj_value_computed;
	}
	...
	public double getFruits_vegetables_legumes_estimate_from_ingredients_100g() {
		return fruits_vegetables_legumes_estimate_from_ingredients_100g;
	}

	public void setFruits_vegetables_legumes_estimate_from_ingredients_100g(
			double fruits_vegetables_legumes_estimate_from_ingredients_100g) {
		this.fruits_vegetables_legumes_estimate_from_ingredients_100g = fruits_vegetables_legumes_estimate_from_ingredients_100g;
	}

	public double getFruits_vegetables_legumes_estimate_from_ingredients_serving() {
		return fruits_vegetables_legumes_estimate_from_ingredients_serving;
	}

	public void setFruits_vegetables_legumes_estimate_from_ingredients_serving(
			double fruits_vegetables_legumes_estimate_from_ingredients_serving) {
		this.fruits_vegetables_legumes_estimate_from_ingredients_serving = fruits_vegetables_legumes_estimate_from_ingredients_serving;
	}
	...
	public void setFruits_vegetables_nuts_estimate_from_ingredients_100g(
			double fruits_vegetables_nuts_estimate_from_ingredients_100g) {
		this.fruits_vegetables_nuts_estimate_from_ingredients_100g = fruits_vegetables_nuts_estimate_from_ingredients_100g;
	}

	public double getFruits_vegetables_nuts_estimate_from_ingredients_serving() {
		return fruits_vegetables_nuts_estimate_from_ingredients_serving;
	}

	public void setFruits_vegetables_nuts_estimate_from_ingredients_serving(
			double fruits_vegetables_nuts_estimate_from_ingredients_serving) {
		this.fruits_vegetables_nuts_estimate_from_ingredients_serving = fruits_vegetables_nuts_estimate_from_ingredients_serving;
	}
	...
	public void setNova_group_100g(int nova_group_100g) {
	...
	public void setNova_group_serving(int nova_group_serving) {
	...
	public void setNutrition_score_fr(int nutrition_score_fr) {
	...
	public void setNutrition_score_fr_100g(int nutrition_score_fr_100g) {
